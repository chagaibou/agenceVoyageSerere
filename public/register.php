...
<body class="main-container"> <!-- Correction: layout propre à la page login -->
    <main class="relative flex-grow w-full overflow-x-hidden">
        <header  class="w-screen h-screen overflow-x-hidden bg-none">
            <div class="fixed topbar">
                ...
                <div class="actions-buttons">
                    ...
                    <section id="registrerForm" class="absolute flex flex-col items-center w-5/6 px-4 py-6 bg-white rounded-md top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 max-h-[90vh] overflow-y-auto">
            <h2 class="w-full text-3xl h-1/10 flex-centered text-emerald-600 font-aref-ruqaa">
                Inscription
            </h2>
            <p>Créer un nouveau compte</p>
            <form action="post" class="flex flex-col items-center justify-start w-full gap-y-4">
                <div class="flex items-center justify-between w-full p-1 h-max gap-x-2">
                    <div class="w-1/2 h-full form-items">
                ...
                <div class="flex items-center justify-between w-full p-1 h-max gap-x-2">
                    <div class="w-1/2 h-full form-items">
                        ...
                        <input type="email" name="phone" id="phone" placeholder="Entrer votre adresse email">
                    </div>
                    <div class="w-1/2 h-full form-items">
                        <i class="fa-solid fa-phone"></i>
                ...
                <div class="flex items-center justify-between w-full p-1 h-max gap-x-2">
                    <div class="w-full h-full form-items flex-centered">
    ...
    <!-- <footer class="w-full h-1/6 bg-emerald-400">
        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Libero deserunt velit sed. Corporis laboriosam quidem quisquam,
         suscipit necessitatibus, eos recusandae cum alias, inventore tempore reiciendis voluptates non consequatur atque sint.
    </footer> -->
</body>
</html>